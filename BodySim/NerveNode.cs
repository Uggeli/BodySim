...
public class NerveNode : BodyPartNodeBase, IResourceNeedComponent, IResourceProductionComponent
{
    ...
    public NerveNode(BodyPartType bodyPartType, bool isCentral = false, bool isMajorHub = false,
        float nerveSignalMax = 100f, float painOverloadThreshold = 80f)
        : base(bodyPartType, [
            new BodyComponentBase(100, 100, 0.2f, BodyComponentType.Health),
            new BodyComponentBase(nerveSignalMax, nerveSignalMax, 0.3f, BodyComponentType.NerveSignal),
        ...
        ])
    {
        ...
        PainOverloadThreshold = painOverloadThreshold;
    ...
    public float GetSignalStrength()
    {
        ...
        float signalMax = GetComponent(BodyComponentType.NerveSignal)?.Max ?? 100f;
        float healthMax = GetComponent(BodyComponentType.Health)?.Max ?? 100f;
        float signalPct = signalMax > 0 ? signal / signalMax : 0;
        float healthPct = healthMax > 0 ? health / healthMax : 0;
